...
const initialTasks: Task[] = [
  ...
  // Backend 보드 작업들 (계층 구조)
  {
    id: "BACKEND-1",
    boardId: "board-backend",
    title: "REST API 개발",
    description: "작업 관리 시스템의 RESTful API 전체 개발. 사용자 인증, 작업 CRUD, 알림 등 핵심 기능을 포함한 완전한 백엔드 API를 구축합니다. Express.js 기반으로 구현하며, OpenAPI 스펙 문서화도 함께 진행합니다.",
    status: "IN_PROGRESS",
    assignee: "김백엔드",
    isImportant: true,
    createdAt: nowIso(),
  ...
  },
  {
    ...
    boardId: "board-backend",
    title: "API 엔드포인트 설계",
    description: "RESTful API 엔드포인트 설계 및 문서화. GET, POST, PUT, DELETE 메서드를 활용한 리소스 기반 URL 구조 설계. Swagger/OpenAPI 3.0 스펙으로 API 문서 작성 완료.",
    status: "DONE",
    assignee: "김백엔드",
    createdAt: nowIso(),
    updatedAt: nowIso(),
  },
  {
    ...
    boardId: "board-backend",
    title: "데이터베이스 연동",
    description: "PostgreSQL 데이터베이스 연결 및 ORM 설정. TypeORM을 사용하여 데이터베이스 연결 풀 관리, 트랜잭션 처리, 마이그레이션 시스템 구축. 환경별 설정 분리 및 연결 테스트 완료.",
    status: "IN_PROGRESS",
    assignee: "이데이터",
    createdAt: nowIso(),
    updatedAt: nowIso(),
  },
  {
    ...
    boardId: "board-backend",
    title: "스키마 설계",
    description: "데이터베이스 스키마 설계 및 마이그레이션 스크립트 작성. 작업(Task), 사용자(User), 보드(Board), 관계(Relation) 등 핵심 엔티티의 ERD 설계 완료. 외래키 제약조건 및 인덱스 설계 포함.",
    status: "DONE",
    assignee: "이데이터",
    createdAt: nowIso(),
    updatedAt: nowIso(),
  },
  {
    ...
    boardId: "board-backend",
    title: "쿼리 최적화",
    description: "데이터베이스 쿼리 성능 최적화 및 인덱스 설계. EXPLAIN ANALYZE를 활용한 쿼리 실행 계획 분석, N+1 문제 해결을 위한 JOIN 최적화, 복합 인덱스 설계 및 쿼리 캐싱 전략 수립.",
    status: "TODO",
    assignee: "이데이터",
    createdAt: nowIso(),
    updatedAt: nowIso(),
  },
  {
    ...
    boardId: "board-backend",
    title: "인증/인가 구현",
    description: "JWT 기반 인증 및 역할 기반 접근 제어(RBAC) 구현. Access Token과 Refresh Token 발급/갱신 로직, 비밀번호 해싱(bcrypt), 권한 미들웨어 구현. OAuth 2.0 연동 준비 중.",
    status: "IN_PROGRESS",
    assignee: "박보안",
    createdAt: nowIso(),
    updatedAt: nowIso(),
  },
  {
    id: "BACKEND-1-4",
    boardId: "board-backend",
    title: "작업 CRUD API 구현",
    description: "작업 생성, 조회, 수정, 삭제 API 엔드포인트 구현. 페이징, 필터링, 정렬 기능 포함. 입력 검증 및 에러 핸들링, 단위 테스트 및 통합 테스트 작성 예정.",
    status: "TODO",
    assignee: "김백엔드",
    createdAt: nowIso(),
    updatedAt: nowIso(),
  ...
  // Agent 보드 작업들 (계층 구조)
  {
    ...
    boardId: "board-agent",
    title: "AI 에이전트 개발",
    description: "작업 관리 자동화를 위한 AI 에이전트 시스템 개발. LLM을 활용하여 작업 자동 분류, 우선순위 추천, 스마트 알림 생성 등 지능형 기능을 제공하는 에이전트를 구축합니다. LangChain 기반으로 구현 중.",
    status: "IN_PROGRESS",
    assignee: "정AI",
    isImportant: true,
    createdAt: nowIso(),
  ...
  },
  {
    ...
    boardId: "board-agent",
    title: "프롬프트 엔지니어링",
    description: "작업 분류 및 우선순위 결정을 위한 프롬프트 최적화. Few-shot learning 기법을 활용한 프롬프트 설계, 작업 제목과 설명을 분석하여 카테고리 자동 분류 프롬프트 작성 완료. A/B 테스트를 통한 성능 평가 진행.",
    status: "DONE",
    assignee: "정AI",
    createdAt: nowIso(),
    updatedAt: nowIso(),
  },
  {
    ...
    boardId: "board-agent",
    title: "LLM 모델 통합",
    description: "다양한 LLM 모델 API 통합 및 추상화 레이어 구현. OpenAI GPT-4, Anthropic Claude, Google Gemini 등 여러 모델을 동일한 인터페이스로 사용할 수 있도록 어댑터 패턴 적용. 모델별 특성에 맞는 파라미터 튜닝 및 에러 핸들링 구현 중.",
    status: "IN_PROGRESS",
    assignee: "이모델",
    createdAt: nowIso(),
    updatedAt: nowIso(),
  },
  {
    ...
    boardId: "board-agent",
    title: "OpenAI API 연동",
    description: "GPT-4 모델 API 연동 및 에러 핸들링 구현. OpenAI SDK를 사용하여 채팅 완성 API 연동, 스트리밍 응답 처리, Rate Limit 및 토큰 제한 관리, 재시도 로직 구현 완료. 비용 모니터링 대시보드 연동.",
    status: "DONE",
    assignee: "이모델",
    createdAt: nowIso(),
    updatedAt: nowIso(),
  },
  {
    ...
    boardId: "board-agent",
    title: "Claude API 연동",
    description: "Anthropic Claude 모델 API 연동 및 테스트. Claude 3 Opus 모델을 사용한 작업 분석 기능 구현 중. 긴 컨텍스트 윈도우(200K 토큰)를 활용한 대용량 문서 분석 기능 개발 예정. 응답 품질 평가 및 벤치마크 테스트 진행 중.",
    status: "IN_PROGRESS",
    assignee: "이모델",
    createdAt: nowIso(),
    updatedAt: nowIso(),
  },
  {
    ...
    boardId: "board-agent",
    title: "자동 작업 분류 기능",
    description: "AI를 활용한 작업 자동 분류 및 태그 추천 기능 개발. 작업 제목과 설명을 분석하여 카테고리, 우선순위, 예상 소요 시간을 자동으로 추천. 사용자 피드백을 통한 모델 개선 루프 구축 예정. 정확도 85% 이상 목표.",
    status: "TODO",
    assignee: "정AI",
    createdAt: nowIso(),
    updatedAt: nowIso(),
  },
  {
    ...
    boardId: "board-agent",
    title: "스마트 알림 생성",
    description: "AI 기반 컨텍스트 인식 스마트 알림 메시지 생성 기능. 작업의 맥락을 이해하여 개인화된 알림 메시지 생성. 긴급도에 따른 알림 우선순위 자동 조정, 관련 작업 추천 기능 포함. 사용자 선호도 학습 기능 구현 예정.",
    status: "TODO",
    assignee: "최알림",
    createdAt: nowIso(),
    updatedAt: nowIso(),
...
const initialRelations: TaskRelation[] = [
  ...
  // Backend 보드 내부 SUBTASK 관계 (계층 구조)
  {
    id: "rel-backend-1-1",
    fromTaskId: "BACKEND-1",
    toTaskId: "BACKEND-1-1",
    type: "SUBTASK",
  },
  {
    id: "rel-backend-1-2",
    fromTaskId: "BACKEND-1",
    toTaskId: "BACKEND-1-2",
    type: "SUBTASK",
  },
  {
    id: "rel-backend-1-2-1",
    fromTaskId: "BACKEND-1-2",
    toTaskId: "BACKEND-1-2-1",
    type: "SUBTASK",
  },
  {
    id: "rel-backend-1-2-2",
    fromTaskId: "BACKEND-1-2",
    toTaskId: "BACKEND-1-2-2",
    type: "SUBTASK",
  },
  {
    id: "rel-backend-1-3",
    fromTaskId: "BACKEND-1",
    toTaskId: "BACKEND-1-3",
    type: "SUBTASK",
  },
  {
    id: "rel-backend-1-4",
    fromTaskId: "BACKEND-1",
    toTaskId: "BACKEND-1-4",
    type: "SUBTASK",
  },

  // Agent 보드 내부 SUBTASK 관계 (계층 구조)
  {
    id: "rel-agent-1-1",
    fromTaskId: "AGENT-1",
    toTaskId: "AGENT-1-1",
  ...
  {
    id: "rel-agent-1-2-1",
    fromTaskId: "AGENT-1-2",
    toTaskId: "AGENT-1-2-1",
    type: "SUBTASK",
  },
  {
    id: "rel-agent-1-2-2",
    fromTaskId: "AGENT-1-2",
    toTaskId: "AGENT-1-2-2",
    type: "SUBTASK",
  },
  {
    id: "rel-agent-1-3",
  ...
  // 보드 간 연결 관계 (CROSS_BOARD)
  {
    id: "rel-cross-backend-agent-1",
    fromTaskId: "BACKEND-1",
    toTaskId: "AGENT-1",
    type: "CROSS_BOARD",
    fromBoardId: "board-backend",
    toBoardId: "board-agent",
  },
  {
    id: "rel-cross-backend-agent-2",
    fromTaskId: "BACKEND-1-4",
    toTaskId: "AGENT-1-3",
    type: "CROSS_BOARD",
    fromBoardId: "board-backend",
    toBoardId: "board-agent",
